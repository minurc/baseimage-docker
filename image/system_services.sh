...
rm -f /etc/rsyslog.d/*
cp /build/config/rsyslog_conf /etc/rsyslog.conf
chmod u=rw,g=r,o=r /etc/rsyslog.conf
cp /build/config/rsyslog_conf_70 /etc/rsyslog.d/70-remote.conf
chmod u=rw,g=r,o=r /etc/rsyslog.d/*
